...
function populateTeamTable(data) {
    ...
    renderTable('team-table', 
        ['Name', 'Verantwortlichkeit', 'Status', 'Fortschritt'], 
        data.team, 
        member => `
            <tr>
...
function populateTrainingForm(data) {
    ...
    select.innerHTML = data.team.map(member => 
...
function renderTestTable(data) {
    ...
    renderTable('test-table', 
        ['Sprache', 'Testname', 'Status', 'Zeitpunkt'], 
        data.tests, 
        test => `
            <tr>
